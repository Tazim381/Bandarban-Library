        ...
        <form className="p-8 " onSubmit={handleSubmit}>
          ...
          <div className='flex justify-between'>
            <div className="flex flex-col items-start text-lg mb-4 md:mb-6">
              ...
              <input defaultValue={currentValue.bookName} type="text" name="bookName" className="border-slate-300 hover:border-slate-500 pl-2 border-2 rounded py-1 md:py-2 focus:outline-none w-full" placeholder="Book Name" required />
            </div>
            <div className="flex flex-col items-start text-lg mb-4 md:mb-6">
              <label class="block text-gray-700 text-sm mb-2" for="authorName">
                Author Name
              </label>
              <input defaultValue={currentValue.authorName} type="text" name="authorName" className="border-slate-300 hover:border-slate-500 pl-2 border-2 rounded py-1 md:py-2 focus:outline-none w-full" placeholder="Author Name" required />
            </div>
          </div>
          <div className='flex justify-between'>
            <div className="flex flex-col items-start text-lg mb-4 md:mb-6">
              ...
              <input defaultValue={currentValue.publishedYear} type="text" name="publishedYear" className="border-slate-300 hover:border-slate-500 pl-2 border-2 rounded py-1 md:py-2 focus:outline-none w-full" placeholder="Published Year" required />
            </div>
            <div className="flex flex-col items-start text-lg mb-4 md:mb-6">
              <label class="block text-gray-700 text-sm mb-2" for="bookCategory">
                Book Category
              </label>
              <input defaultValue={currentValue.category} type="text" name="category" className="border-slate-300 hover:border-slate-500 pl-2 border-2 rounded py-1 md:py-2 focus:outline-none w-full" placeholder="Book Category" required />
            </div>
          </div>
          <div className='flex justify-between'>
            <div className="flex flex-col items-start text-lg mb-4 md:mb-6">
